...
public class SubCategoryService : ISubCategoryService
{
    ...
    public SubCategoryService(AppDbContext benayaatEntities)
    {
    ...
    public SM_Sub_Categories CreateSubCategory(SM_Sub_Categories categoryDM)
    {
        try
        {
            var query = (from o in _context.sm_sub_categories
            ...
            {
                _context.sm_sub_categories.Add(categoryDM);
            }
    ...
    public SM_Sub_Categories? GetSubCategory(int category_id)
    {
        ...
        try
        {
            ...
            area = (from o in _context.sm_sub_categories
    ...
    public List<SM_Sub_Categories> GetAllSubCategories()
    {
        ...
        try
        {
            customer = (from o in _context.sm_sub_categories                           
                select o).ToList();
