...
public class CarouselService : ICarouselService
{
    ...
    public CarouselService(AppDbContext appDbContext)
    {
    ...
    public List<SM_Carousels> GetAllCarousels()
    {
        ...
        try
        {
            userMenu = (from o in _context.sm_carousels
    ...
    public SM_Carousels CreateCarousel(SM_Carousels CustomerDM)
    {
        try
        {
            ...
            {
                var Customer = (from o in _context.sm_carousels
            ...
            {
                _context.sm_carousels.Add(CustomerDM);
                _context.SaveChanges();
            }
        }
        catch (Exception ex)
    ...
    public SM_Carousels? UpdateSequence(long carousel_id, int sequence)
    {
        ...
        try
        {
            category = (from o in _context.sm_carousels
