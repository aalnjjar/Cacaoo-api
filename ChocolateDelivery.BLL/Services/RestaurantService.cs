...
public class RestaurantService : IRestaurantService
{
    ...
    public RestaurantService(AppDbContext benayaatEntities)
    {
    ...
    public SM_Restaurants CreateRestaurant(SM_Restaurants restaurantDM)
    {
        try
        {
            ...
            {
                _context.sm_restaurants.Add(restaurantDM);
            }
    ...
    public SM_Restaurants? GetRestaurant(long restaurant_id)
    {
        ...
        try
        {
            area = (from o in _context.sm_restaurants
            ...
            if (area != null)
            {
                ...
                {
                    area.RestaurantStatus = RestaurantStatus.Closed;
                }
            }
        }
        catch (Exception ex)
    ...
    public SM_Restaurants? ValidateMerchant(string userName, string password)
    {
        ...
        try
        {
            userId = (from o in _context.sm_restaurants
    ...
    public List<SM_Restaurant_AddOns> GetAllRestaurantAddOns(long restaurant_id)
    {
        ...
        try
        {
            customer = (from o in _context.sm_restaurant_addons
                where o.Restaurant_Id == restaurant_id
                select o).ToList();
        }
        catch (Exception ex)
