...
public class AppUserService : IAppUserService
{
    ...
    public AppUserService(AppDbContext appDbContext)
    {
    ...
    public App_Users? GetAppUser(string email_id, short login_type)
    {
        ...
        try
        {
            userMenu = (from o in _context.app_users
    ...
    public App_Users CreateAppUser(App_Users PromoterDM)
    {
        try
        {
            ...
            {
                var Promoter = (from o in _context.app_users
            ...
            {
                _context.app_users.Add(PromoterDM);
                _context.SaveChanges();
            }
        }
        catch (Exception ex)
    ...
    public App_Users? ValidateAppUser(string email, string password)
    {
        ...
        try
        {
            userId = (from o in _context.app_users
    ...
    public App_User_Address CreateAppUserAddress(App_User_Address PromoterDM)
    {
        try
        {
            ...
            {
                var Promoter = (from o in _context.app_user_address
            ...
            {
                _context.app_user_address.Add(PromoterDM);
                _context.SaveChanges();
            }
        }
        catch (Exception ex)
    ...
    public App_User_Address? GetUserAddress(long address_id)
    {
        ...
        try
        {
            var query = (from o in _context.app_user_address
                from a in _context.sm_areas
    ...
    public List<App_User_Address> GetUserAddresses(long app_user_id,string lang = "E")
    {
        ...
        {
            var query = (from o in _context.app_user_address
                join a in _context.sm_areas on o.Area_Id equals a.Area_Id into area
    ...
    public bool DeleteUserAddress(long userAddressId)
    {
        try
        {
            ...
            var user = (from o in _context.app_user_address
